          ...
          <div className="flex flex-col lg:flex-row gap-12 md:gap-16 items-start">
            <div className="lg:w-3/5 w-full">
              ...
              <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-start md:items-end w-full">
                <p className="text-base md:text-xl text-cream-700 max-w-md font-light leading-relaxed italic border-l border-border pl-4 md:pl-8">
                ...
                <div className="flex flex-col gap-4 w-full md:w-auto md:min-w-[240px]">
                  <button
                    ...
                    className="w-full py-4 md:py-6 bg-violet-600 text-white rounded-sm text-[10px] uppercase font-black tracking-[0.3em] hover:bg-violet-700 transition-all duration-300 shadow-[0_0_30px_rgba(124,58,237,0.5)] border border-violet-500/50"
                  >
                    Initiate Session
                  </button>
                  <div className="flex justify-between items-center px-2">
                    <span className="text-[8px] md:text-[9px] uppercase font-bold text-cream-300 tracking-widest">Protocol 4.0</span>
                    <button className="text-[8px] md:text-[9px] uppercase font-bold text-muted-foreground hover:text-foreground-bold transition-colors tracking-widest">View Methodology &rarr;</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:w-2/5 pt-12 md:pt-32 w-full">
              <div className="bg-white/40 backdrop-blur-sm border border-border p-6 md:p-10 rounded-sm shadow-premium relative">
                ...
                <div className="space-y-8 md:space-y-10">
                  <div>
                    <div className="text-[8px] md:text-[9px] uppercase font-black text-foreground tracking-[0.2em] md:tracking-[0.3em] mb-3 md:mb-4">01 / Synchronization</div>
                    <p className="text-[10px] md:text-xs text-muted-foreground leading-relaxed font-light uppercase tracking-wider">
                      Orchestrated session triggers ensure absolute temporal fairness across all candidate environments.
                    </p>
                  </div>
                  <div>
                    <div className="text-[8px] md:text-[9px] uppercase font-black text-foreground tracking-[0.2em] md:tracking-[0.3em] mb-3 md:mb-4">02 / Persistence</div>
                    <p className="text-[10px] md:text-xs text-muted-foreground leading-relaxed font-light uppercase tracking-wider">
                      Immutable data mirroring guarantees session resilience against local connectivity interruptions.
                    </p>
                  </div>
                  <div>
                    <div className="text-[8px] md:text-[9px] uppercase font-black text-foreground tracking-[0.2em] md:tracking-[0.3em] mb-3 md:mb-4">03 / Analytics</div>
                    <p className="text-[10px] md:text-xs text-muted-foreground leading-relaxed font-light uppercase tracking-wider">
