...
const techList = [
  ...
  { name: 'JavaScript', color: 'from-blue-400 to-blue-600' },
...
export const SupportedTech: React.FC = () => {
  return (
    <section id="languages" className="py-16 md:py-24 border-y border-border bg-background relative overflow-hidden">
      ...
      <FadeInUp>
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          <div className="text-xs md:text-xl font-black uppercase tracking-[0.4em] text-primary/80 text-center mb-12">
